...
function Layout() {
  ...
  return (
    <div>
       <nav className="bg-onyx text-platinum p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          <img src="Screenshot 2024-09-03 113026.png" alt="Expense Era Logo" className="h-8 w-8 mr-2" />
          <div className="text-2xl font-bold text-green-500">Expense Era</div>
        </div>
      ...
      <footer className="bg-onyx text-platinum py-8">
